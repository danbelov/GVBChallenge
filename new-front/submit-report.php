...
<body>
    ...
    <div class="container-holder">
        <div class="container container-first" style="display: none;">
                <label for="">Um was geht es?</label>
                <input type = "text" name =""/>
                <button class="btn btn-default" type="button" onclick="next('.container-second');">Weiter</button>
        </div>
        <div class="container container-second" style="display: none;">
                <label for="">Was ist passiert?</label>
                <input type = "text" name ="">
                <textarea>
